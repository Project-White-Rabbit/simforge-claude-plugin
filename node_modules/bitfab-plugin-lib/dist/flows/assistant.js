...
{{whens}}`,
                ...
                },
                {
                    id: "evaluate-results",
                    kind: "action",
                    toolCalls: ["read", "write", "readTraces", "updateAgentLabels"],
...
1. Call {{tool:readTraces}} with \`scope: "full"\` on the replayed trace IDs (the ones from the new test run, not the originals) to read their outputs.
...
3. Call {{tool:updateAgentLabels}} once with an array of \`{ traceId, label, annotation }\` for every replayed trace:
