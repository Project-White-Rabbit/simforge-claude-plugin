...
Get the user's confirmation before proceeding.`,
        ...
        },
        {
            ...
            intro: `Run an iterative improvement loop.{{#claude}} If experiments are independent, fork them to subagents in parallel using the **Agent tool** with \`isolation: "worktree"\`.{{/claude}} Each iteration:
