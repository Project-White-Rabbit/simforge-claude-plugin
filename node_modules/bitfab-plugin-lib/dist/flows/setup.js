...
- Call {{tool:createTracePlan}} with \`{ language, tree, capturedNodeIds }\` (and \`stats\` if you have a sample run) — \`capturedNodeIds\` is your initial recommendation, must form a connected sub-tree (selecting any descendant implies its ancestors). The tool returns a plan id (and a \`https://bitfab.ai/trace-plan/<id>\` URL).
